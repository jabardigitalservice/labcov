    ...
    <div class="form-group row mt-4">
     ...
     <div class="mt-4" id="inputrslain" style="display: none;">
      <div class="form-group row">
        <label class="col-md-2"></label>
        <div class="col-md-6">
          <input class="multisteps-form__input form-control" type="text" name="reg_nama_rs_lainnya" placeholder="Nama Rumah Sakit / Fasyankes"/>
        </div>
      </div>
    </div>
...
<div class="form-check form-check-inline">
 ...
 <div class="mt-4" id="ktp" style="display: none;">
   ...
   <div class="form-group row mt-4">
     ...
     <div class="col-md-6">
     <div class="form-check form-check-inline">
  <input class="form-check-input" id="kellaki" type="radio" name="reg_kelamin" value="Laki Laki" onclick="show1();" required>
  <label class="form-check-label" for="kellaki">Laki Laki</label>
</div>
<div class="form-check form-check-inline">
  <input class="form-check-input" id="kelperempuan" type="radio" name="reg_kelamin" value="Perempuan" onclick="show2();" >
...
<div class="mt-4" id="ifcewe" style="display: none;">
              <div class="form-group row">
                ...
                <div class="col-md-6">
                <div class="form-check form-check-inline">
  <input class="form-check-input" type="radio" id="pascaya" name="reg_hamil_pasca" value="Ya">
  <label class="form-check-label" for="pascaya">Ya</label>
</div>
<div class="form-check form-check-inline">
  <input class="form-check-input" type="radio" id="pascano" name="reg_hamil_pasca" value="Tidak">
...
<div class="form-check form-check-inline">
  ...
  <label class="form-check-label" for="kunke7">Ke-7</label>
              ...
              <input class="multisteps-form__input form-control" type="text" id="tanggalkunjungan" name="reg_tanggalkunjungan" placeholder="Tanggal Kunjungan"/>
              
              </div>
              <div class="col-md-6">
              <label>Rumah Sakit / Fasyankes</label>
              <input class="multisteps-form__input form-control" type="text" name="reg_rsfasyankes" placeholder="Nama RS/Fasyankes"/>
              </div>
            </div>
...
<textarea class="form-control" rows="3" name="rar_keterangan">isikan Jenis sampel dan keterangan penting lainnya</textarea>
            ...
            <div class="form-group row mt-4">
                ...
                <div class="col-md-6">
               <input class="multisteps-form__input form-control" type="text" id="onsetpanas" name="reg_onset_panas" placeholder="Tanggal Onset Panas"/>
                </div>
              </div>
            <div class="form-group row mt-4">
                ...
                <div class="col-md-6">
                <div class="form-check form-check-inline">
  <input class="form-check-input" type="radio" id="gejpanasya" name="reg_gejpanas" value="Ya">
  <label class="form-check-label" for="gejpanasya">Ya</label>
</div>
<div class="form-check form-check-inline">
  <input class="form-check-input" type="radio" id="gejpanasno" name="reg_gejpanas" value="Tidak">
  <label class="form-check-label" for="gejpanasno">Tidak</label>
</div>
<div class="form-check form-check-inline">
  <input class="form-check-input" type="radio" id="gejpanasnull" name="reg_gejpanas" value="Tidak Diisi">
  <label class="form-check-label" for="gejpanasnull">Tidak Diisi</label>
              ...
              <div class="form-group row mt-4">
                ...
                <div class="col-md-6">
                <div class="form-check form-check-inline">
  <input class="form-check-input" type="radio" id="gejpneumoniaya" name="reg_gejpenumonia" value="Ya">
  <label class="form-check-label" for="gejpneumoniaya">Ya</label>
</div>
<div class="form-check form-check-inline">
  <input class="form-check-input" type="radio" id="gejpneumoniano" name="reg_gejpenumonia" value="Tidak">
  <label class="form-check-label" for="gejpneumoniano">Tidak</label>
</div>
<div class="form-check form-check-inline">
  <input class="form-check-input" type="radio" id="gejpneumonianull" name="reg_gejpenumonia" value="Tidak Diisi">
  <label class="form-check-label" for="gejpneumonianull">Tidak Diisi</label>
              ...
              <div class="form-group row mt-4">
                ...
                <div class="col-md-6">
                <div class="form-check form-check-inline">
  <input class="form-check-input" type="radio" id="gejbatukya" name="reg_gejbatuk" value="Ya">
  <label class="form-check-label" for="gejbatukya">Ya</label>
</div>
<div class="form-check form-check-inline">
  <input class="form-check-input" type="radio" id="gejbatukno" name="reg_gejbatuk" value="Tidak">
  <label class="form-check-label" for="gejbatukno">Tidak</label>
</div>
<div class="form-check form-check-inline">
  <input class="form-check-input" type="radio" id="gejbatuknull" name="reg_gejbatuk" value="Tidak Diisi">
  <label class="form-check-label" for="gejbatuknull">Tidak Diisi</label>
              ...
              <div class="form-group row mt-4">
                ...
                <div class="col-md-6">
                <div class="form-check form-check-inline">
  <input class="form-check-input" type="radio" id="gejnyeritenggorokanya" name="reg_gejnyeritenggorokan" value="Ya">
  <label class="form-check-label" for="gejnyeritenggorokanya">Ya</label>
</div>
<div class="form-check form-check-inline">
  <input class="form-check-input" type="radio" id="gejnyeritenggorokanno" name="reg_gejnyeritenggorokan" value="Tidak">
  <label class="form-check-label" for="gejnyeritenggorokanno">Tidak</label>
</div>
<div class="form-check form-check-inline">
  <input class="form-check-input" type="radio" id="gejnyeritenggorokannull" name="reg_gejnyeritenggorokan" value="Tidak Diisi">
  <label class="form-check-label" for="gejnyeritenggorokannull">Tidak Diisi</label>
</div>
                </div>
              </div>
              <div class="form-group row mt-4">
                ...
                <div class="col-md-6">
                <div class="form-check form-check-inline">
  <input class="form-check-input" type="radio" id="gejsesaknafasya" name="reg_gejsesaknafas" value="Ya">
  <label class="form-check-label" for="gejsesaknafasya">Ya</label>
</div>
<div class="form-check form-check-inline">
  <input class="form-check-input" type="radio" id="gejsesaknafasno" name="reg_gejsesaknafas" value="Tidak">
  <label class="form-check-label" for="gejsesaknafasno">Tidak</label>
</div>
<div class="form-check form-check-inline">
  <input class="form-check-input" type="radio" id="gejsesaknafasnull" name="reg_gejsesaknafas" value="Tidak Diisi">
  <label class="form-check-label" for="gejsesaknafasnull">Tidak Diisi</label>
              ...
              <div class="form-group row mt-4">
                ...
                <div class="col-md-6">
                <div class="form-check form-check-inline">
  <input class="form-check-input" type="radio" id="gejpilekya" name="reg_gejpilek" value="Ya">
  <label class="form-check-label" for="gejpilekya">Ya</label>
</div>
<div class="form-check form-check-inline">
  <input class="form-check-input" type="radio" id="gejpilekno" name="reg_gejpilek" value="Tidak">
  <label class="form-check-label" for="gejpilekno">Tidak</label>
</div>
<div class="form-check form-check-inline">
  <input class="form-check-input" type="radio" id="gejpileknull" name="reg_gejpilek" value="Tidak Disii">
  <label class="form-check-label" for="gejpileknull">Tidak Diisi</label>
              ...
              <div class="form-group row mt-4">
                ...
                <div class="col-md-6">
                <div class="form-check form-check-inline">
  <input class="form-check-input" type="radio" id="gejlesuya" name="reg_gejlesu" value="Ya">
  <label class="form-check-label" for="gejlesuya">Ya</label>
</div>
<div class="form-check form-check-inline">
  <input class="form-check-input" type="radio" id="gejlesuno" name="reg_gejlesu" value="Tidak">
  <label class="form-check-label" for="gejlesuno">Tidak</label>
</div>
<div class="form-check form-check-inline">
  <input class="form-check-input" type="radio" id="gejlesunull" name="reg_gejlesu" value="Tidak Diisi">
  <label class="form-check-label" for="gejlesunull">Tidak Diisi</label>
              ...
              <div class="form-group row mt-4">
                ...
                <div class="col-md-6">
                <div class="form-check form-check-inline">
  <input class="form-check-input" type="radio" id="gejsakitkepalaya" name="reg_gejsakitkepala" value="Ya">
  <label class="form-check-label" for="gejsakitkepalaya">Ya</label>
</div>
<div class="form-check form-check-inline">
  <input class="form-check-input" type="radio" id="gejsakitkepalano" name="reg_gejsakitkepala" value="Tidak">
  <label class="form-check-label" for="gejsakitkepalano">Tidak</label>
</div>
<div class="form-check form-check-inline">
  <input class="form-check-input" type="radio" id="gejsakitkepalanull" name="reg_gejsakitkepala" value="Tidak Diisi">
  <label class="form-check-label" for="gejsakitkepalanull">Tidak Diisi</label>
              ...
              <div class="form-group row mt-4">
                ...
                <div class="col-md-6">
                <div class="form-check form-check-inline">
  <input class="form-check-input" type="radio" id="gejdiareya" name="reg_gejdiare" value="Ya">
  <label class="form-check-label" for="gejdiareya">Ya</label>
</div>
<div class="form-check form-check-inline">
  <input class="form-check-input" type="radio" id="gejdiareno" name="reg_gejdiare" value="Tidak">
  <label class="form-check-label" for="gejdiareno">Tidak</label>
</div>
<div class="form-check form-check-inline">
  <input class="form-check-input" type="radio" id="gejdiarenull" name="reg_gejdiare" value="Tidak Diisi">
  <label class="form-check-label" for="gejdiarenull">Tidak Diisi</label>
              ...
              <div class="form-group row mt-4">
                ...
                <div class="col-md-6">
                <div class="form-check form-check-inline">
  <input class="form-check-input" type="radio" id="gejmualmuntahya" name="reg_gejmualmuntah" value="Ya">
  <label class="form-check-label" for="gejmualmuntahya">Ya</label>
</div>
<div class="form-check form-check-inline">
  <input class="form-check-input" type="radio" id="gejmualmuntahno"  name="reg_gejmualmuntah" value="Tidak">
  <label class="form-check-label" for="gejmualmuntahno">Tidak</label>
</div>
<div class="form-check form-check-inline">
  <input class="form-check-input" type="radio" id="gejmualmuntahnull" name="reg_gejmualmuntah" value="Tidak">
  ...
  <textarea class="form-control" rows="3" name="reg_gejlain" id="gejlain"></textarea>
        ...
        <div id="sw-default-step-4">
            <div class="form-group row mt-4">
                ...
                <div class="col-md-6">
                <div class="form-check form-check-inline">
  <input class="form-check-input" type="radio" id="xrayya" name="reg_xrayparu" value="Ya">
  <label class="form-check-label" for="xrayya">Ya</label>
</div>
<div class="form-check form-check-inline">
  <input class="form-check-input" type="radio" id="xrayno" name="reg_xrayparu" value="Tidak">
  ...
  <textarea class="form-control" rows="3" name="reg_hasilxray" id="hasilxray"></textarea>
            ...
            <div class="form-group row mt-4">
                ...
                <div class="col-md-6">
                <div class="form-check form-check-inline">
  <input class="form-check-input" type="radio" id="ventilatorya" name="reg_ventilator" value="Ya">
  <label class="form-check-label" for="ventilatorya">Ya</label>
</div>
<div class="form-check form-check-inline">
  <input class="form-check-input" type="radio" id="ventilatorno" name="reg_ventilator" value="Tidak">
  <label class="form-check-label" for="ventilatorno">Tidak</label>
              ...
              <div class="form-group row mt-4">
                ...
                <div class="col-md-6">
                <div class="form-check form-check-inline">
  <input class="form-check-input" type="radio" id="pulang" name="reg_statuskes" value="Pulang">
  <label class="form-check-label" for="pulang">Pulang</label>
</div>
<div class="form-check form-check-inline">
  <input class="form-check-input" type="radio" id="dirawat" name="reg_statuskes" value="Dirawat">
  <label class="form-check-label" for="dirawat">Dirawat</label>
</div>
<div class="form-check form-check-inline">
  <input class="form-check-input" type="radio" id="meninggal" name="reg_statuskes" value="Meninggal">
  ...
  <textarea class="form-control" rows="5" name="reg_hasillablainnya"></textarea>
        ...
        <div id="sw-default-step-5">
            <div class="form-group row mt-4">
                ...
                <div class="col-md-6">
                <div class="form-check form-check-inline">
  <input class="form-check-input" type="radio" id="luarnegriya" name="reg_luarnegri" value="Ya">
  <label class="form-check-label" for="luarnegriya">Ya</label>
</div>
<div class="form-check form-check-inline">
  <input class="form-check-input" type="radio" id="luarnegrino" name="reg_luarnegri" value="Tidak">
    ...
    <div class="input-group col-md-4">
      ...
      <input class="multisteps-form__input form-control" type="text" name="reg_negarakunjungan_pasien7"/>
            ...
            <div class="form-group row mt-4">
                ...
                <div class="col-md-6">
                <div class="form-check form-check-inline">
  <input class="form-check-input" type="radio" id="kontakdgnsakitya" name="reg_kontakdgnsakit" value="Ya">
  <label class="form-check-label" for="kontakdgnsakitya">Ya</label>
</div>
<div class="form-check form-check-inline">
  <input class="form-check-input" type="radio" id="kontakdgnsakitno" name="reg_kontakdgnsakit" value="Tidak">
...
<div class="input-group col-md-2">
  ...
  <input class="multisteps-form__input form-control" type="text" id="tanggalkonakhir7" name="reg_tanggalkonakhir7"/>
            ...
            <div class="form-group row mt-4">
                ...
                <div class="col-md-6">
                <div class="form-check form-check-inline">
  <input class="form-check-input" type="radio" id="kontakterinfeksiya" name="reg_kontakterinfeksi" value="Ya">
  <label class="form-check-label" for="kontakterinfeksiya">Ya</label>
</div>
<div class="form-check form-check-inline">
  <input class="form-check-input" type="radio" id="kontakterinfeksino" name="reg_kontakterinfeksi" value="Tidak">
  <label class="form-check-label" for="kontakterinfeksino">Tidak</label>
              ...
              <div class="form-group row mt-4">
                ...
                <div class="col-md-6">
                <div class="form-check form-check-inline">
  <input class="form-check-input" type="radio" id="keluargapasienya" name="reg_keluargapasiensakitsama" value="Ya">
  <label class="form-check-label" for="keluargapasienya">Ya</label>
</div>
<div class="form-check form-check-inline">
  <input class="form-check-input" type="radio" id="keluargapasienno" name="reg_keluargapasiensakitsama" value="Tidak">
  <label class="form-check-label" for="keluargapasienno">Tidak</label>
        ...
        <div id="sw-default-step-6">
            ...
            <div class="form-group row mt-4">
                ...
                <div class="col-md-6">
                <div class="form-check form-check-inline">
  <input class="form-check-input" type="radio" id="komorbidhipertensiya" name="reg_komorbidhipertensi" value="Ya">
  <label class="form-check-label" for="komorbidhipertensiya">Ya</label>
</div>
<div class="form-check form-check-inline">
  <input class="form-check-input" type="radio" id="komorbidhipertensino" name="reg_komorbidhipertensi" value="Tidak">
  <label class="form-check-label" for="komorbidhipertensino">Tidak</label>
</div>
<div class="form-check form-check-inline">
  <input class="form-check-input" type="radio" id="komorbidhipertensinull" name="reg_komorbidhipertensi" value="Tidak Diisi">
  <label class="form-check-label" for="komorbidhipertensinull">Tidak Diisi</label>
              ...
              <div class="form-group row mt-4">
                ...
                <div class="col-md-6">
                <div class="form-check form-check-inline">
  <input class="form-check-input" type="radio" id="komorbiddmya" name="reg_komorbiddm" value="Ya">
  <label class="form-check-label" for="komorbiddmya">Ya</label>
</div>
<div class="form-check form-check-inline">
  <input class="form-check-input" type="radio" id="komorbiddmno" name="reg_komorbiddm" value="Tidak">
  <label class="form-check-label" for="komorbiddmno">Tidak</label>
</div>
<div class="form-check form-check-inline">
  <input class="form-check-input" type="radio" id="komorbiddmnull" name="reg_komorbiddm" value="Tidak Diisi">
  <label class="form-check-label" for="komorbiddmnull">Tidak Diisi</label>
              ...
              <div class="form-group row mt-4">
                ...
                <div class="col-md-6">
                <div class="form-check form-check-inline">
  <input class="form-check-input" type="radio" id="komorbidliverya" name="reg_komorbidliver" value="Ya">
  <label class="form-check-label" for="komorbidliverya">Ya</label>
</div>
<div class="form-check form-check-inline">
  <input class="form-check-input" type="radio" id="komorbidliverno" name="reg_komorbidliver" value="Tidak">
  <label class="form-check-label" for="komorbidliverno">Tidak</label>
</div>
<div class="form-check form-check-inline">
  <input class="form-check-input" type="radio" id="komorbidlivernull" name="reg_komorbidliver" value="Tidak Diisi">
  <label class="form-check-label" for="komorbidlivernull">Tidak Diisi</label>
              ...
              <div class="form-group row mt-4">
                ...
                <div class="col-md-6">
                <div class="form-check form-check-inline">
  <input class="form-check-input" type="radio" id="komorbidneurologiya" name="reg_komorbidneurologi" value="Ya">
  <label class="form-check-label" for="komorbidneurologiya">Ya</label>
</div>
<div class="form-check form-check-inline">
  <input class="form-check-input" type="radio" id="komorbidneurologino" name="reg_komorbidneurologi" value="Tidak">
  <label class="form-check-label" for="komorbidneurologino">Tidak</label>
</div>
<div class="form-check form-check-inline">
  <input class="form-check-input" type="radio" id="komorbidneurologinull" name="reg_komorbidneurologi" value="Tidak Diisi">
  <label class="form-check-label" for="komorbidneurologinull">Tidak Diisi</label>
              ...
              <div class="form-group row mt-4">
                ...
                <div class="col-md-6">
                <div class="form-check form-check-inline">
  <input class="form-check-input" type="radio" id="komorbidhivya" name="reg_komorbidhiv" value="Ya">
  <label class="form-check-label" for="komorbidhivya">Ya</label>
</div>
<div class="form-check form-check-inline">
  <input class="form-check-input" type="radio" id="komorbidhivno" name="reg_komorbidhiv" value="Tidak">
  <label class="form-check-label" for="komorbidhivno">Tidak</label>
</div>
<div class="form-check form-check-inline">
  <input class="form-check-input" type="radio" id="komorbidhivnull" name="reg_komorbidhiv" value="Tidak Diisi">
  <label class="form-check-label" for="komorbidhivnull">Tidak Diisi</label>
              ...
              <div class="form-group row mt-4">
                ...
                <div class="col-md-6">
                <div class="form-check form-check-inline">
  <input class="form-check-input" type="radio" id="komorbidparuya" name="reg_komorbidparu" value="Ya">
  <label class="form-check-label" for="komorbidparuya">Ya</label>
</div>
<div class="form-check form-check-inline">
  <input class="form-check-input" type="radio" id="komorbidparuno" name="reg_komorbidparu" value="Tidak">
  <label class="form-check-label" for="komorbidparuno">Tidak</label>
</div>
<div class="form-check form-check-inline">
  <input class="form-check-input" type="radio" id="komorbidparunull" name="reg_komorbidparu" value="Tidak Diisi">
  <label class="form-check-label" for="komorbidparunull">Tidak Diisi</label>
              ...
              <div class="form-group row mt-4">
                ...
                <div class="col-md-6">
                <div class="form-check form-check-inline">
  <input class="form-check-input" type="radio" id="komorbidginjalya" name="reg_komorbidginjal" value="Ya">
  <label class="form-check-label" for="komorbidginjalya">Ya</label>
</div>
<div class="form-check form-check-inline">
  <input class="form-check-input" type="radio" id="komorbidginjalno" name="reg_komorbidginjal" value="Tidak">
  <label class="form-check-label" for="komorbidginjalno">Tidak</label>
</div>
<div class="form-check form-check-inline">
  <input class="form-check-input" type="radio" id="komorbidginjalnull" name="reg_komorbidginjal" value="Tidak Diisi">
