...
@section('content')
            ...
            <div class="content">
              ...
              <td><p>Kesimpulan Pemeriksaan : @if($a->rapid_kesimpulan_rdt_1 == "Reaktif")
                  <span class="badge badge-danger">{{$a->rapid_kesimpulan_rdt_1 }}</span> 
                @else 
                 <span class="badge badge-success">{{$a->rapid_kesimpulan_rdt_1 }}</span> 
                @endif </p></td>
              <td><a href="{{url('validasi/rdt/verify/'.$a->rapid_id)}}" class="btn btn-sm btn-primary"><i class="uil-eye"></i>Detail</a>
                                        </tr>
                                        @endforeach
                                            </tbody>
                                        </table>
...
@endif </p></td>
<td><a href="{{url('validasi/rdt/print/'.$a->val_id)}}" class="btn btn-sm btn-primary"><i class="uil-print"></i> Print / Download</a>
    <a href="{{url('validasi/rdt/detail/'.$a->val_id)}}" class="btn btn-sm btn-info"><i class="uil-info-circle"></i> Detail</a>
    </tr>
    @endforeach
        </tbody>
    </table>
