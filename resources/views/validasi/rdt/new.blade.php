                ...
                <div class="container-fluid">
                    <div class="row page-title align-items-center">
                        <div class="col-sm-4 col-xl-6">
                            <a href="{{url('validasi/rdt/')}}" class="btn btn-xs btn-primary float-left mr-3"><i class="uil-arrow-left"></i></a> <h3 class="header-title  mb-1 mt-0">Detail Status </h3>
                        </div>
                        <div class="col-sm-8 col-xl-6">
                          @if($validated)
                       <a href="{{url('validasi/rdt/print/'.$validated->val_id)}}" class="btn btn-sm btn-primary float-right ml-2"><i class="uil-print"></i> Print / Download</a>
                       @else
                       @endif
                      </div>
                    </div>
...
<form method="POST" action="{{url('validasi/rdt/verify')}}">
    @csrf
...
<div class="form-check form-check-inline">
  ...
  <input type="hidden" name="val_pemid" value="{{$show->rapid_id}}" >
  <input type="hidden" name="val_samid" value="{{$show->rapid_sampel_id}}" >
