...
<form method="POST" action="{{url('ekstraksi/pilih')}}">
    ...
    @endif
    <p><span class="badge badge-info">Pilih sampel untuk dikirimkan</span> <span class="badge badge-warning">Masukan kode tempat penyimpanan di kolom yang tersedia untuk semua sampel yang tidak dipilih</span></p>
 ...
 <div id="form-group row">
   <div class="col-md-2">
    <input class="form-check-input" type="radio" name="eks_samid" value="{{$s->sam_id}}" required>
   </div>
   <div class="col-md-10">
    <div class="media mb-3">
...
<div id="myModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" style="display: none;" aria-hidden="true">
 ...
 <input type="hidden" name="eks_penid" value="{{$selected->pen_id}}">
    ...
    <div class="form-group row mt-4">
      ...
      <div class="col-md-6">
     <input class="form-control" type="text" name="eks_operator_ekstraksi" placeholder="Opertor ekstraksi"/>
      </div>
    </div>
    ...
    <div class="form-group row mt-4">
      ...
      <div class="col-md-6">
        <input class="form-check-input" type="radio" name="eks_dikirim_ke_lab" value="Unpad" ><label>Unpad</label>
        <br>
        <input class="form-check-input" type="radio" name="eks_dikirim_ke_lab" value="LABKES" ><label>LABKES</label>
        <br>
