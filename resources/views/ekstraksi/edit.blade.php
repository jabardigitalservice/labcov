@extends('layouts.web')
@section('title','- Ubah Penerimaan dan Ekstraksi RNA')
@section('css')
...
@section('content')
                ...
                <div class="container-fluid">
                    <div class="row page-title align-items-center">
                         <div class="col-sm-4 col-xl-6">
                            <h4 class="mb-1 mt-0">Ubah Penerimaan dan Ekstraksi RNA</h4>
                        </div>
  ...
  <div class="row">
      <div class="col-12">
          <div class="card">
              <div class="card-body">  
                @if(!is_null($selected->pen_noreg) && !is_null($selected->pen_nik))
...
<div id="myModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" style="display: none;" aria-hidden="true">
 ...
 <input type="hidden" name="oldsamid" value="{{$edit->eks_samid}}">
    ...
    <div class="form-group row mt-4">
     ...
     <input class="form-control" type="text" name="eks_nama_lab_lain" @if(is_null($edit->eks_dikirim_ke_lab)) {{$edit->eks_nama_lab_lain}} @endif/>
      </div>
    </div>
    ...
    <div class="form-group row">
      ...
      <div class="col-md-10">
<textarea class="form-control" rows="5" name="eks_catatan" placeholder="Catatan">{{$edit->eks_catatan}}</textarea>
      </div>
  </div>
...
<div class="form-group row mt-4">
    <div class="col-md-12">
<button class="btn btn-md btn-primary" type="submit">Ubah</button>
    </div>
</div>
